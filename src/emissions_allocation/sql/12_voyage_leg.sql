-- §2 output: voyage_leg -- one row per consecutive port pair.
--
...
--
-- `is_eu_eu` is the reason this table exists. Section 5 assigns distillate fuel to any
...
SELECT
    ...
    -- countries. Section 2's ">95% of hours in one EEZ" test is kept as the cross-check
