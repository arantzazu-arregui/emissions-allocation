-- §3.2 output: voyage_leg -- one row per consecutive port pair.
--
...
--
-- `is_eu_eu` is the reason this table exists. §5.1 assigns distillate fuel to any
...
SELECT
    ...
    -- countries. §6's ">95% of hours in one EEZ" test is kept as the cross-check
